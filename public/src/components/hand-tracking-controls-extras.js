      ...
      function (require, module, exports) {
        ...
        function HandData() {
          ...
          const joints = {
            ...
            // thumb
            T_Metacarpal: new _JointObject.JointObject(
              "thumb-metacarpal",
              num++,
              this
            ),
            T_Proximal: new _JointObject.JointObject(
              "thumb-phalanx-proximal",
              num++,
              this
            ),
            T_Distal: new _JointObject.JointObject(
            ...
            // index
            I_Metacarpal: new _JointObject.JointObject(
              "index-finger-metacarpal",
              num++,
              this
            ),
            I_Proximal: new _JointObject.JointObject(
              "index-finger-phalanx-proximal",
              num++,
              this
            ),
            I_Intermediate: new _JointObject.JointObject(
              "index-finger-phalanx-intermediate",
              num++,
              this
            ),
            I_Distal: new _JointObject.JointObject(
              "index-finger-phalanx-distal",
              num++,
              this
            ),
            I_Tip: new _JointObject.JointObject(
              "index-finger-tip",
              num++,
              this
            ),
            // middle
            M_Metacarpal: new _JointObject.JointObject(
              "middle-finger-metacarpal",
              num++,
              this
            ),
            M_Proximal: new _JointObject.JointObject(
              "middle-finger-phalanx-proximal",
              num++,
              this
            ),
            M_Intermediate: new _JointObject.JointObject(
              "middle-finger-phalanx-intermediate",
              num++,
              this
            ),
            M_Distal: new _JointObject.JointObject(
              "middle-finger-phalanx-distal",
              num++,
              this
            ),
            M_Tip: new _JointObject.JointObject(
              "middle-finger-tip",
              num++,
              this
            ),
            // ring
            R_Metacarpal: new _JointObject.JointObject(
              "ring-finger-metacarpal",
              num++,
              this
            ),
            R_Proximal: new _JointObject.JointObject(
              "ring-finger-phalanx-proximal",
              num++,
              this
            ),
            R_Intermediate: new _JointObject.JointObject(
              "ring-finger-phalanx-intermediate",
              num++,
              this
            ),
            R_Distal: new _JointObject.JointObject(
            ...
            // little
            L_Metacarpal: new _JointObject.JointObject(
              "pinky-finger-metacarpal",
              num++,
              this
            ),
            L_Proximal: new _JointObject.JointObject(
              "pinky-finger-phalanx-proximal",
              num++,
              this
            ),
            L_Intermediate: new _JointObject.JointObject(
              "pinky-finger-phalanx-intermediate",
              num++,
              this
            ),
            L_Distal: new _JointObject.JointObject(
              "pinky-finger-phalanx-distal",
              num++,
              this
            ),
            L_Tip: new _JointObject.JointObject(
              "pinky-finger-tip",
              num++,
              this
            ),
